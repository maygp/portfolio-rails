...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { cidade: @aluno.cidade, curso: @aluno.curso, email: @aluno.email, nome: @aluno.nome, telefone: @aluno.telefone } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { cidade: @aluno.cidade, curso: @aluno.curso, email: @aluno.email, nome: @aluno.nome, telefone: @aluno.telefone } }
